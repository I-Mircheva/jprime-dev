...
public class CfpController extends AbstractCfpController {
    ...
    public static final Logger logger = LogManager.getLogger(CfpController.class);
	...
	public String loadMailContentTemplate(String templateFileName) throws IOException, URISyntaxException {
		return new String(Files.readAllBytes(Paths.get(getClass().getResource("/" + templateFileName).toURI())));
	}

	public String prepareNewSubmissionContent(Submission submission, String template) {
